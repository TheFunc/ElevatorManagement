...
<div class="card max-w-2xl mx-auto">
    ...
    <div class="space-y-6">
                ...
                <div id="checkDisplay">
                    <p class="text-lg font-semibold">
                        <?php if($check && $check->next_check_at): ?>
                            ...
                            ?>
                            <span class="<?php echo e($daysDiff < 0 ? 'text-red-600' : ($daysDiff <= 30 ? 'text-yellow-600' : ($daysDiff <= 60 ? 'text-orange-500' : 'text-green-600'))); ?>">
        ...
        <div class="bg-gray-50 p-4 rounded-lg">
            ...
            <p class="text-gray-800 whitespace-pre-line"><?php echo e($device->desc); ?></p>
        </div>
