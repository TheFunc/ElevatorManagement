<?php $__env->startSection('title', '资料查询'); ?>
<?php $__env->startSection('page-title', '资料查询'); ?>
        ...
        <div class="flex flex-wrap gap-3 items-end">
            ...
            <div class="w-48">
                ...
                <select name="type" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-primary outline-none">
                    ...
                    <option value="<?php echo e($key); ?>" <?php echo e(request('type') == $key ? 'selected' : ''); ?>><?php echo e($type['name']); ?></option>
            ...
            <?php if(request('keyword') || request('type')): ?>
            <div>
                <a href="<?php echo e(route('data.query')); ?>" class="px-6 py-2 bg-gray-300 text-gray-700 rounded-lg hover:bg-gray-400 transition-colors inline-block">
                    重置
                </a>
            </div>
            <?php endif; ?>
        ...
        <table class="w-full">
                    ...
                    <th class="px-4 py-3 text-left text-sm font-medium text-gray-600">
                        <a href="<?php echo e(route('data.query', array_merge(request()->all(), ['sort' => 'created_at', 'order' => request('order', 'asc') == 'asc' ? 'desc' : 'asc']))); ?>" class="inline-flex items-center gap-1 hover:text-primary transition-colors group">
                            ...
                            <span class="inline-flex flex-col text-[10px] leading-none opacity-40 group-hover:opacity-100 transition-opacity">
                                ...
                                <i class="ri-arrow-down-s-line <?php echo e($currentOrder == 'desc' ? 'text-primary opacity-100' : ''); ?>" style="margin-top: -2px;"></i>
                            </span>
                        </a>
                    </th>
            ...
            <tbody>
                ...
                <tr class="border-b border-gray-100 hover:bg-gray-50">
                    <td class="px-4 py-3">
                        <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-<?php echo e($fileTypes[$file->type]['color']); ?>-100 text-<?php echo e($fileTypes[$file->type]['color']); ?>-700">
                            <i class="<?php echo e($fileTypes[$file->type]['icon']); ?> mr-1"></i>
                    ...
                    <td class="px-4 py-3">
                        ...
                        <button type="button" class="text-red-600 hover:text-red-800 font-medium" onclick="showDeleteConfirm(<?php echo e($file->id); ?>)">
