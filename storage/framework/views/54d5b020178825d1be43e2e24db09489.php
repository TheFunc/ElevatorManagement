<?php $__env->startSection('title', '维保记录'); ?>
<?php $__env->startSection('page-title', '维保记录'); ?>

<?php $__env->startSection('content'); ?>
<div class="card">
    <div class="flex justify-between items-center mb-6">
        <h3 class="text-xl font-semibold text-gray-800">维保记录管理</h3>
        <a href="<?php echo e(route('data.upload')); ?>" class="px-4 py-2 bg-primary text-white rounded-lg hover:bg-dark transition-colors">
    ...
    <form action="" method="GET" class="mb-6">
        <div class="flex gap-3">
            <input type="text" name="keyword" value="<?php echo e(request('keyword')); ?>" placeholder="搜索维保记录标题或描述..." class="flex-1 px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-primary outline-none">
            ...
            <a href="<?php echo e(route('elevator.maintenance')); ?>" class="px-6 py-2 bg-gray-300 text-gray-700 rounded-lg hover:bg-gray-400 transition-colors">
                重置
            </a>
            <?php endif; ?>
        </div>
        ...
        <table class="w-full">
            ...
            <tbody>
                ...
                <tr class="border-b border-gray-100 hover:bg-gray-50">
                    ...
                    <td class="px-4 py-3">
                        <a href="<?php echo e(route('file.download', $file->id)); ?>" class="text-green-600 hover:text-green-800 font-medium">
...
<?php echo $__env->make('layouts.elevator', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\else\order\ElevatorManagement\ElevatorManagement\resources\views/elevator/maintenance.blade.php ENDPATH**/ ?>