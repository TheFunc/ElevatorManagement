<?php $__env->startSection('title', '文本类型管理'); ?>
<?php $__env->startSection('page-title', '文本类型管理'); ?>
    ...
    <div class="text-type-table-wrapper overflow-x-auto">
        <table class="text-type-table min-w-full bg-white border border-gray-200 rounded-lg">
            ...
            <tbody class="divide-y divide-gray-200">
                <?php $__currentLoopData = $textTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $textType): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr class="hover:bg-gray-50">
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900"><?php echo e($textType->id); ?></td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900"><?php echo e($textType->type); ?></td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500"><?php echo e($textType->created_at->format('Y-m-d H:i:s')); ?></td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500"><?php echo e($textType->updated_at->format('Y-m-d H:i:s')); ?></td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-type-actions">
                        <button onclick="editTextType(<?php echo e($textType->id); ?>, '<?php echo e($textType->type); ?>')" class="text-indigo-600 hover:text-indigo-900">
                            <i class="ri-edit-line"></i> 编辑
                        </button>
                        <button onclick="deleteTextType(<?php echo e($textType->id); ?>)" class="text-red-600 hover:text-red-900">
...
<div id="typeModal" class="fixed inset-0 bg-black bg-opacity-50 hidden items-center justify-center z-50">
    <div class="bg-white rounded-lg w-full max-w-md mx-4 p-6">
        ...
        <form id="typeForm" action="<?php echo e(route('text-type.store')); ?>" method="POST">
            <?php echo csrf_field(); ?>
...
function showAddModal() {
    ...
    document.getElementById('typeForm').action = '<?php echo e(route('text-type.store')); ?>';
...
<?php echo $__env->make('layouts.elevator', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\else\order\ElevatorManagement\ElevatorManagement\resources\views/text-management/types.blade.php ENDPATH**/ ?>